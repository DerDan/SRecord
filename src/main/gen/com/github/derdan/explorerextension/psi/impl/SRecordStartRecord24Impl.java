...
public class SRecordStartRecord24Impl extends ASTWrapperPsiElement implements SRecordStartRecord24 {

  public SRecordStartRecord24Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SRecordVisitor visitor) {
    visitor.visitStartRecord24(this);
  }
