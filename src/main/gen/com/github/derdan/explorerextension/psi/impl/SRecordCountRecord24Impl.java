...
public class SRecordCountRecord24Impl extends ASTWrapperPsiElement implements SRecordCountRecord24 {

  public SRecordCountRecord24Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SRecordVisitor visitor) {
    visitor.visitCountRecord24(this);
  }
