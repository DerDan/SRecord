...
public class SRecordDataRecord32Impl extends ASTWrapperPsiElement implements SRecordDataRecord32 {

  public SRecordDataRecord32Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SRecordVisitor visitor) {
    visitor.visitDataRecord32(this);
  }
