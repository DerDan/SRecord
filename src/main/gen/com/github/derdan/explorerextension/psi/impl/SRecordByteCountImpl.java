...
public class SRecordByteCountImpl extends ASTWrapperPsiElement implements SRecordByteCount {

  public SRecordByteCountImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SRecordVisitor visitor) {
    visitor.visitByteCount(this);
  }
