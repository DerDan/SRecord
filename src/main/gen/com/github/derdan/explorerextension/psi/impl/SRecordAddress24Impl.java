...
public class SRecordAddress24Impl extends ASTWrapperPsiElement implements SRecordAddress24 {

  public SRecordAddress24Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SRecordVisitor visitor) {
    visitor.visitAddress24(this);
  }
