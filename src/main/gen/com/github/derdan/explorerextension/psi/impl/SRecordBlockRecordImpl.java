...
public class SRecordBlockRecordImpl extends ASTWrapperPsiElement implements SRecordBlockRecord {

  public SRecordBlockRecordImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SRecordVisitor visitor) {
    visitor.visitBlockRecord(this);
  }
