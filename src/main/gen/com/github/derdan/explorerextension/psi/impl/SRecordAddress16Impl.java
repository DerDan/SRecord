...
public class SRecordAddress16Impl extends ASTWrapperPsiElement implements SRecordAddress16 {

  public SRecordAddress16Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SRecordVisitor visitor) {
    visitor.visitAddress16(this);
  }
