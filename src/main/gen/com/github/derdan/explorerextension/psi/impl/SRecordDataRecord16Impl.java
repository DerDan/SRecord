...
public class SRecordDataRecord16Impl extends ASTWrapperPsiElement implements SRecordDataRecord16 {

  public SRecordDataRecord16Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SRecordVisitor visitor) {
    visitor.visitDataRecord16(this);
  }
